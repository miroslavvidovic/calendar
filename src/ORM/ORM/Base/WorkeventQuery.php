...
use ORM\ORM\Map\WorkeventTableMap;
...
/**
 * Base class that represents a query for the 'WorkEvent' table.
 *
 *
 *
 * @method     ChildWorkeventQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildWorkeventQuery orderByDescription($order = Criteria::ASC) Order by the description column
 * @method     ChildWorkeventQuery orderByLocation($order = Criteria::ASC) Order by the location column
 * @method     ChildWorkeventQuery orderByCalendareventId($order = Criteria::ASC) Order by the CalendarEvent_id column
 *
 * @method     ChildWorkeventQuery groupById() Group by the id column
 * @method     ChildWorkeventQuery groupByDescription() Group by the description column
 * @method     ChildWorkeventQuery groupByLocation() Group by the location column
 * @method     ChildWorkeventQuery groupByCalendareventId() Group by the CalendarEvent_id column
 *
 * @method     ChildWorkeventQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method     ChildWorkeventQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method     ChildWorkeventQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildWorkeventQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildWorkeventQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildWorkeventQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 * @method     ChildWorkeventQuery leftJoinCalendarevent($relationAlias = null) Adds a LEFT JOIN clause to the query using the Calendarevent relation
 * @method     ChildWorkeventQuery rightJoinCalendarevent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Calendarevent relation
 * @method     ChildWorkeventQuery innerJoinCalendarevent($relationAlias = null) Adds a INNER JOIN clause to the query using the Calendarevent relation
 *
 * @method     ChildWorkeventQuery joinWithCalendarevent($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Calendarevent relation
 *
 * @method     ChildWorkeventQuery leftJoinWithCalendarevent() Adds a LEFT JOIN clause and with to the query using the Calendarevent relation
 * @method     ChildWorkeventQuery rightJoinWithCalendarevent() Adds a RIGHT JOIN clause and with to the query using the Calendarevent relation
 * @method     ChildWorkeventQuery innerJoinWithCalendarevent() Adds a INNER JOIN clause and with to the query using the Calendarevent relation
 *
 * @method     \ORM\ORM\CalendareventQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildWorkevent findOne(ConnectionInterface $con = null) Return the first ChildWorkevent matching the query
 * @method     ChildWorkevent findOneOrCreate(ConnectionInterface $con = null) Return the first ChildWorkevent matching the query, or a new ChildWorkevent object populated from the query conditions when no match is found
 *
 * @method     ChildWorkevent findOneById(int $id) Return the first ChildWorkevent filtered by the id column
 * @method     ChildWorkevent findOneByDescription(string $description) Return the first ChildWorkevent filtered by the description column
 * @method     ChildWorkevent findOneByLocation(string $location) Return the first ChildWorkevent filtered by the location column
 * @method     ChildWorkevent findOneByCalendareventId(int $CalendarEvent_id) Return the first ChildWorkevent filtered by the CalendarEvent_id column *

 * @method     ChildWorkevent requirePk($key, ConnectionInterface $con = null) Return the ChildWorkevent by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildWorkevent requireOne(ConnectionInterface $con = null) Return the first ChildWorkevent matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildWorkevent requireOneById(int $id) Return the first ChildWorkevent filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildWorkevent requireOneByDescription(string $description) Return the first ChildWorkevent filtered by the description column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildWorkevent requireOneByLocation(string $location) Return the first ChildWorkevent filtered by the location column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildWorkevent requireOneByCalendareventId(int $CalendarEvent_id) Return the first ChildWorkevent filtered by the CalendarEvent_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildWorkevent[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildWorkevent objects based on current ModelCriteria
 * @method     ChildWorkevent[]|ObjectCollection findById(int $id) Return ChildWorkevent objects filtered by the id column
 * @method     ChildWorkevent[]|ObjectCollection findByDescription(string $description) Return ChildWorkevent objects filtered by the description column
 * @method     ChildWorkevent[]|ObjectCollection findByLocation(string $location) Return ChildWorkevent objects filtered by the location column
 * @method     ChildWorkevent[]|ObjectCollection findByCalendareventId(int $CalendarEvent_id) Return ChildWorkevent objects filtered by the CalendarEvent_id column
 * @method     ChildWorkevent[]|\Propel\Runtime\Util\PropelModelPager paginate($page = 1, $maxPerPage = 10, ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 *
 */
abstract class WorkeventQuery extends ModelCriteria
{
...
protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';
    ...
    /**
     * Initializes internal state of \ORM\ORM\Base\WorkeventQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\ORM\\ORM\\Workevent', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildWorkeventQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildWorkeventQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildWorkeventQuery) {
            return $criteria;
        }
        $query = new ChildWorkeventQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildWorkevent|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(WorkeventTableMap::DATABASE_NAME);
        }
        ...
        if ((null !== ($obj = WorkeventTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
     ...
     *
     * @return ChildWorkevent A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        $sql = 'SELECT id, description, location, CalendarEvent_id FROM WorkEvent WHERE id = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildWorkevent $obj */
            $obj = new ChildWorkevent();
            $obj->hydrate($row);
            WorkeventTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildWorkeventQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(WorkeventTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(WorkeventTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(WorkeventTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(WorkeventTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(WorkeventTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(WorkeventTableMap::COL_DESCRIPTION, $description, $comparison);
    }
    ...
    public function filterByLocation($location = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(WorkeventTableMap::COL_LOCATION, $location, $comparison);
    }
    ...
    public function filterByCalendareventId($calendareventId = null, $comparison = null)
    {
        if (is_array($calendareventId)) {
            ...
            if (isset($calendareventId['min'])) {
                $this->addUsingAlias(WorkeventTableMap::COL_CALENDAREVENT_ID, $calendareventId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($calendareventId['max'])) {
                $this->addUsingAlias(WorkeventTableMap::COL_CALENDAREVENT_ID, $calendareventId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(WorkeventTableMap::COL_CALENDAREVENT_ID, $calendareventId, $comparison);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildWorkeventQuery The current query, for fluid interface
     */
    public function filterByCalendarevent($calendarevent, $comparison = null)
    {
        if ($calendarevent instanceof \ORM\ORM\Calendarevent) {
            return $this
                ->addUsingAlias(WorkeventTableMap::COL_ID, $calendarevent->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(WorkeventTableMap::COL_ID, $calendarevent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param   ChildWorkevent $workevent Object to remove from the list of results
     *
     * @return $this|ChildWorkeventQuery The current query, for fluid interface
     */
    public function prune($workevent = null)
    {
        if ($workevent) {
            $this->addUsingAlias(WorkeventTableMap::COL_ID, $workevent->getId(), Criteria::NOT_EQUAL);
        }
    ...
    /**
     * Deletes all rows from the WorkEvent table.
     *
    ...
    {
        if (null === $con) {
            $con = Propel::getServiceContainer()->getWriteConnection(WorkeventTableMap::DATABASE_NAME);
        }
        ...
        return $con->transaction(function () use ($con) {
            ...
            WorkeventTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(WorkeventTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            WorkeventTableMap::removeInstanceFromPool($criteria);
